...
#game window
window = tkinter.Tk()
window.title("Snake Game Python By DiffaJl")
...
def change_direction(e): #e = event
    global velocityX, velocityY, game_over, score, snake, snake_body, food
...
def draw():
    ...
    if (game_over):
        ...
        canvas.create_text(WINDOW_WIDTH/2, WINDOW_HEIGHT/2 + 30, font = "Arial 10", text = "Klik 'P' untuk bermain lagi dan 'Q' untuk keluar", fill = "white")
    else:
